              ...
              if (_revealAnimGrade.value > 0)
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    if (_revealAnimParticle.status == AnimationStatus.forward ||
                        _revealAnimParticle.status == AnimationStatus.reverse) {
                      shouldPaint = true;
                    }

                    String? rr = rarities[widget.grade.value.getRarity()];
